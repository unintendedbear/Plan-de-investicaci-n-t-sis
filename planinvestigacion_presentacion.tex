...
\begin{itemize}
  ...
  \begin{itemize}
    \item<5-> Incluidos datos de contexto.
  \end{itemize}
\end{itemize}
...
\begin{itemize}
  \item<1-> Escenario BYOD estudiado en el proyecto MUSES.
  \item<2-> Estudio del estado del arte en herramientas que abordan la situación BYOD.\footnote{{\scriptsize de las Cuevas, P., García-Sánchez, P., Merelo, J. J., García-Arenas, M.I.(2017). \textit{Comparing individual representation and evaluation for automatic rule extraction using GP in a BYOD scenario}. Pendiente de envío a revista.}}
  \begin{itemize}
    \item<3-> Estudio de distintos fitness.
  \end{itemize}
  \item<4-> Estudio de distintas maneras de representar los individuos.
  \begin{itemize}
    \item<5-> Representas los individuos como conjuntos de reglas y no como reglas individuales da mejores resultados (bajo número de FP).
  \end{itemize}
\end{itemize}
...
\begin{small}
\begin{description}
  \item[3.a]<1-> Estudio del arte en técnicas Soft Computing y Machine Learning aplicadas a los entornos identificados.
...
\begin{small}
\begin{description}
  \item[4.a]<1-> Estudio de las técnicas de pre-procesamiento y elección de una o varias, justificando el por qué.
  \item[4.b]<2-> Creación de un \textit{benchmark} para la experimentación a partir de datos reales.
\end{description}
\end{small}
...
\begin{small}
\begin{description}
  \item[4.c]<1-> Diseñar y definir el entorno de procesamiento con las técnicas escogidas en el segundo objetivo de la tesis.
