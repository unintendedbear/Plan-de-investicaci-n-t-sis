...
\begin{itemize}
  ...
  \item<2-> La bibliografía se centra en asegurar las comunicaciones y en la privacidad del usuario.
...
\begin{itemize}
  ...
  \begin{itemize}
    \item<5-> Representar los individuos como conjuntos de reglas y no como reglas individuales da mejores resultados (bajo número de FP).
  \end{itemize}
\end{itemize}
