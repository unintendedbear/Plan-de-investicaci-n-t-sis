...
\title{A rule inference and refinement methodology to enforce corporate security through Soft Computing}
...
Firma: & \tabularnewline
 ...
 & \tabularnewline
\hline 
Título provisional de la tesis: & A rule inference and refinement methodology to enforce corporate security through Soft Computing\tabularnewline
...
\hline 
Apellidos y nombre: & García Arenas, María Isabel\tabularnewline
Correo electrónico: & mgarenas@ugr.es\tabularnewline
\hline 
...
Correo electrónico: & pablo.garciasanchez@uca.es \tabularnewline
\hline 
\end{tabular}
\end{table}
...
La tesis tiene por título ``A rule inference and refinement methodology to enforce corporate security through Soft Computing'', en español ``Metodología para la inferencia y refinamiento de reglas que mejoren la seguridad corporativa a través de Soft Computing''. 
...
Para definir correctamente la metodología, se necesita completar las siguientes tareas:
...
Se propone la co-dirección de Pablo García Sánchez, profesor sustituto interino del Departamento de Ingeniería Informática de la Universidad de Cádiz. Las razones de esta decisión vienen dadas por el carácter multidisciplinar de la misma, al combinar el uso de algoritmos de Soft Computing con distintas tecnologías relacionadas con el Big Data. El profesor García aporta su experiencia en el desarrollo del framework Osgiliath para programación genética, del que es autor, así como su conocimiento en dispositivos móviles y arquitecturas orientadas a servicio, como puede consultarse en su sección de publicaciones. Además, es el profesor responsable de las asignaturas ``Sistemas Distribuidos'' y ``Programación Paralela y Distribuida'' del grado en Ingeniería Informática de la Universidad de Cádiz. Finalmente, el profesor García se considera director {\em novel}, ya que, a pesar de haber dirigido varios Trabajos Fin de Máster y Trabajos Fin de Grado, aún no ha dirigido ninguna tesis. Ha de aclararse, además, que el profesor García Sánchez ya fue aprobado como co-director en la solicitud anterior a esta nueva memoria de investigación.

En la Tabla \ref{tab:tareasdir} se especifican las tareas de las que se ocuparán tanto la directora de la tesis, la profesora María Isabel García Arenas, como el co-director, el profesor Pablo García Sánchez.
...
\part{Modificaciones de la tesis}

Se ha cambiado el título de ``Soft Computing Techniques applied to Corporate Security'' a ``A rule inference and refinement methodology to enforce corporate security through Soft Computing'', puesto que describe mejor los contenidos de la tesis y el trabajo realizado.

No se solicita ningún cambio más.
